...
//!
//! The StatusBar displays application state and provides:
//!
//! - Current mode indicator (Normal, Insert, Command, Search)
//! - Focused panel information
//! - File path display
...
//! use crate::components::tui::focus::AppMode;
//!
//! let mut bar = StatusBar::new();
//! bar.set_mode(AppMode::Normal);
//! bar.set_file_path(Some("src/main.rs".to_string()));
//! ```

use crate::components::tui::focus::{AppMode, FocusPanel};
...
impl StatusBar {
    ...
    fn get_mode_style(&self, mode: AppMode) -> Style {
        match mode {
            ...
            AppMode::Plan => Style::default().fg(self.theme.palette.secondary),
        }
    }

    fn get_key_hints(&self) -> Vec<Span<'_>> {
