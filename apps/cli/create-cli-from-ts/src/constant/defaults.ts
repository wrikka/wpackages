...
export const DEFAULT_DESCRIPTION_TEMPLATE = (packageName: string) => `Bundled package for ${packageName}`;

export const DEFAULT_README_TEMPLATE = (packageName: string, files: string[]) =>
  `# ${packageName}
