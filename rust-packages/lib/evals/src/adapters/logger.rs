...
impl LoggerFactory {
    ...
    pub fn create(component: &str) -> Logger {
        Logger::new(component.to_string())
    }

    /// Create logger with prefix
    pub fn create_with_prefix(prefix: &str, component: &str) -> Logger {
        Logger::new(format!("{}::{}", prefix, component))
    }
}
