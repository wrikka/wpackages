//! Telemetry initialization for the task library
//!
...
/// Initialize the tracing subscriber for task operations
///
...
/// - `TASK_LOG`: Set task-specific log level (e.g., `task=debug`)
///
/// # Example
///
/// ```rust,no_run
...
///
/// Initialize the tracing subscriber for logging and tracing
