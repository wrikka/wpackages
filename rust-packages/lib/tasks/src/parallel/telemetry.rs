//! Telemetry initialization for the parallel library
//!
...
/// Initialize the tracing subscriber for parallel operations
///
...
/// - `PARALLEL_LOG`: Set parallel-specific log level (e.g., `parallel=debug`)
///
/// # Example
///
/// ```rust,no_run
/// use parallel::telemetry::init_subscriber;
///
/// fn main() {
///     init_subscriber();
