//! Telemetry and logging setup for Context Suite
//!
//! This module provides centralized logging configuration using the `tracing` crate.

use tracing_subscriber::{EnvFilter, FmtSubscriber};

/// Initializes the global tracing subscriber for the context suite.
///
...
///
/// ```no_run
/// use context::telemetry::init_subscriber;
///
/// fn main() {
///     init_subscriber();
...
/// # Arguments
///
/// * `prefix` - The prefix for environment variables (e.g., "CONTEXT_")
///
/// # Example
///
/// ```no_run
/// use context::telemetry::init_subscriber_with_prefix;
///
/// fn main() {
///     init_subscriber_with_prefix("CONTEXT_");
/// }
/// ```
pub fn init_subscriber_with_prefix(_prefix: &str) {
    let filter = EnvFilter::try_from_default_env().unwrap_or_else(|_| EnvFilter::new("info"));
