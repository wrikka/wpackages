import { group } from "../../components/workflow/group";
import type { PromptDescriptor, PromptResult } from "../../types";
...
export const wizardBuilder = (): WizardBuilder<{}> => createWizardBuilder({ prompts: {} });
