...
<template>
  <div class="p-4 sm:p-6 lg:p-8">
    <h1 class="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">Dependency Graph</h1>
    <div ref="graphContainer" class="w-full h-[800px] border rounded-lg bg-white dark:bg-gray-800"></div>
  </div>
</template>
