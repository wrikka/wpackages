  ...
  <div style="font-family: sans-serif; padding: 2rem;">
    ...
    <div v-if="webcontainer">
      ...
      <div style="margin-bottom: 1rem;">
        <input v-model="newItemName" placeholder="Enter name..." @keyup.enter="handleMkdir" />
...
onMounted(() => {
  try {
    ...
    history.value.push({ type: 'info', content: 'SandboxRuntime Initialized. Type a command and press Enter.' });
    focusInput();
  } catch (e) {
    console.error("Error initializing SandboxRuntime:", e);
    history.value.push({ type: 'error', content: 'Failed to load WebAssembly module.' });
  }
});
